...
export const metadata: Metadata = {
  title: "ぬきたし5日目（コメント付き） - Endless Stream（エンスト）",
  openGraph: {
    images: "/nukitashi-5.png",
  },
  twitter: {
    ...
    <div className="flex flex-col h-screen bg-background">
      ...
      <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
        <div className="flex-1 overflow-auto">
          <Video
            src="https://r2.endless.stream/eed7fb4cffe48f5aad6a8e4c42c4346e/manifest/video.m3u8"
            thumbnails="https://r2.endless.stream/eed7fb4cffe48f5aad6a8e4c42c4346e/thumbnails/storyboard.json"
          />
          <VideoMetadata />
        </div>
      </div>
